package ru.alekseiadamov.cloudstorage.common;
...
public class ServerResponse {
    ...
    public static final String UPLOAD_READY = "/uploadReady";
    public static final String UPLOAD_OK = "/uploadOk";
    public static final String UPLOAD_FAIL = "/uploadFail";
    public static final String DOWNLOAD_READY = "/downloadReady";
